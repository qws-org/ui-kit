...
}`,...(ge=(pe=w.parameters)==null?void 0:pe.docs)==null?void 0:ge.source}}};const fe=["Default","WithCustomClass","DynamicMargin","Positioning","Dimension","Background","BackgroundHover","BackgroundHoverGroup","borderColor","BorderRadius","shadows","opacity","overflow","dataAttributes"];export{m as Background,l as BackgroundHover,u as BackgroundHoverGroup,h as BorderRadius,c as Default,g as Dimension,d as DynamicMargin,p as Positioning,i as WithCustomClass,fe as __namedExportsOrder,b as borderColor,w as dataAttributes,xe as default,f as opacity,v as overflow,x as shadows};
