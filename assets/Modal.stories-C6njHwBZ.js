...
Этот компонент реализует доступный способ отображения модальных окон с использованием библиотеки @react-aria.`}}},argTypes:{label:{control:"text",description:"Текст, отображаемый на кнопке, которая открывает модалку."},isDismissable:{control:"boolean",description:"Позволяет ли модалке быть закрытой по клику вне ее или по нажатию на клавишу Escape."}}},g={render:()=>e.jsx(u,{label:"Open default Modal",isDismissable:!0,children:a=>e.jsxs("div",{className:"p-4",children:[e.jsx("h2",{children:"Default Modal"}),e.jsx("p",{children:"This is a basic modal with simple text content."}),e.jsx("button",{onClick:a,className:"mt-4 bg-blue-500 text-white p-2 rounded",children:"Close Modal"})]})})},h={render:()=>e.jsx(u,{label:"Open Form Modal",isDismissable:!0,closeButtonSlot:a=>e.jsx(o,{onPress:a,autoFocus:!0,variant:"default",bg:"background-accent1",border:{width:"2"},position:{type:"absolute",top:20,right:20},md:{position:{top:36,right:40}},children:e.jsx(E,{viewBox:"0 0 32 32",className:"w-6 h-6 md:w-8 md:h-8"})}),children:a=>e.jsxs("form",{className:"flex flex-col",children:[e.jsx("label",{htmlFor:"first-name",className:"mb-2",children:"First Name:"}),e.jsx("input",{id:"first-name",placeholder:"John",className:"p-2 border border-gray-300 rounded-md"}),e.jsx("label",{htmlFor:"last-name",className:"mt-4 mb-2",children:"Last Name:"}),e.jsx("input",{id:"last-name",placeholder:"Doe",className:"p-2 border border-gray-300 rounded-md"}),e.jsx(o,{className:"mt-4",onPress:a,children:"Submit"})]})})},y={render:()=>e.jsx(u,{label:"Non-Dismissable Modal",children:a=>e.jsxs("div",{className:"p-4",children:[e.jsx("h2",{children:"Non-Dismissible Modal"}),e.jsx("p",{children:"This modal cannot be closed by clicking outside or pressing the Escape key."}),e.jsx("button",{onClick:a,className:"mt-4 bg-blue-500 text-white p-2 rounded",children:"Close Modal"})]})})},x={render:()=>e.jsx(f,{state:{isOpen:!0,open(){},close(){},setOpen(){},toggle(){}},p:{pt:12,pb:16,pr:16,pl:16},md:{p:{pt:36}},children:e.jsx(r,{align:"center",flexDirection:"column",p:{px:8},children:e.jsxs(W,{border:{radius:"0px"},p:{px:16},variant:"default",bg:"orange",minWidth:312,maxWidth:768,width:"100vw",height:"100vh",md:{maxHeight:644,maxWidth:360},"data-testid":"registration-form",display:"block",children:[e.jsxs("form",{onSubmit:()=>{},autoComplete:"off",children:[e.jsxs(r,{justify:"space-between",align:"center",p:{py:12},maxHeight:56,children:[e.jsx(O,{as:"p"}),e.jsx(c,{as:"p",m:{mb:0},fontSize:"title.mobile.xsmall",lineHeight:"title.mobile.xsmall",fontWeight:"mobile.bold",horizontalAlign:"center","data-testid":"registration-form-title",children:"Sign Up"}),e.jsx(r,{justify:"center",align:"center",height:32,width:32,cursor:"pointer",p:8,border:{radius:"8px",width:"1px",color:"border-subtle"},children:"X"})]}),e.jsx(w,{bg:"surface-neutral-dark-default",label:"Email","data-testid":"registration-form-email-input",m:{mb:8}}),e.jsx(w,{bg:"surface-neutral-dark-default",label:"Email","data-testid":"registration-form-email-input",m:{mb:8}}),e.jsx(w,{bg:"surface-neutral-dark-default",label:"Email","data-testid":"registration-form-email-input",m:{mb:8}}),e.jsx(r,{m:{mb:16},md:{m:{mb:24}},children:e.jsx(K,{"aria-label":"label","data-testid":"registration-form-remember-password-checkbox",children:e.jsxs(r,{flexWrap:"wrap",whiteSpace:"nowrap",gap:2,align:"center",children:[e.jsx(c,{color:"text-primary-muted",fontSize:"body.mobile.xsmall",lineHeight:"body.mobile.xsmall",children:'"I am 18 years old and I accept the"'}),e.jsx(o,{href:"",p:{px:0,py:0},color:"text-selection",size:"small",variant:"tertiary",fontSize:"body.mobile.xsmall",lineHeight:"body.mobile.xsmall",children:"Terms and Conditions"}),e.jsx(c,{color:"text-primary-muted",fontSize:"body.mobile.xsmall",lineHeight:"body.mobile.xsmall",children:"and"}),e.jsx(o,{href:"",p:{px:0,py:0},color:"text-selection",size:"small",variant:"tertiary",fontSize:"body.mobile.xsmall",lineHeight:"body.mobile.xsmall",children:"Privacy Policy"})]})})}),e.jsx(o,{type:"submit",size:"small",weight:"bold",md:{fontSize:"button.desktop.medium"},p:{py:12},width:"100%",maxHeight:"none",minHeight:"none",height:"fit-content","data-testid":"registration-form-submit-button",children:"SIGN UP"})]}),e.jsxs(r,{gap:8,m:{mt:16},justify:"center",children:[e.jsx(c,{fontSize:"body.mobile.xsmall",lineHeight:"body.mobile.xsmall",children:"Have an account?"}),e.jsx(c,{fontSize:"body.mobile.xsmall",lineHeight:"body.mobile.xsmall",color:"text-selection",className:"cursor-pointer",children:"Log In"})]})]})})})},v={render:()=>e.jsx(u,{label:"",customTrigger:e.jsx(o,{variant:"primary",children:"Custom trigger"}),children:a=>e.jsxs(r,{bg:"white",width:200,flexDirection:"column",p:10,gap:20,children:["Custom trigger modal",e.jsx(o,{variant:"accent",bg:"yellow",onPress:a,children:"Close"})]})})};var q,N,S;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
...
}`,...(S=(N=g.parameters)==null?void 0:N.docs)==null?void 0:S.source}}};var z,T,C;h.parameters={...h.parameters,docs:{...(z=h.parameters)==null?void 0:z.docs,source:{originalSource:`{
...
}`,...(C=(T=h.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var k,F,M;y.parameters={...y.parameters,docs:{...(k=y.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(M=(F=y.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};var D,B,_;x.parameters={...x.parameters,docs:{...(D=x.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => <Modal state={{
    isOpen: true,
    open() {},
    close() {},
...
}`,...(_=(B=x.parameters)==null?void 0:B.docs)==null?void 0:_.source}}};var H,$,I;v.parameters={...v.parameters,docs:{...(H=v.parameters)==null?void 0:H.docs,source:{originalSource:`{
...
}`,...(I=($=v.parameters)==null?void 0:$.docs)==null?void 0:I.source}}};const Te=["Default","FormModal","NonDismissibleModal","ValueChain","CustomTrigger"];export{v as CustomTrigger,g as Default,h as FormModal,y as NonDismissibleModal,x as ValueChain,Te as __namedExportsOrder,ze as default};
