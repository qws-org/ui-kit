import{j as e}from"./index-Ft8_MerW.js";import{B as m}from"./Button-EikDOQpV.js";import{A as F,C as T,y as C,D as P,m as B,E as O,F as k,B as E}from"./useUiKitTheme-BNHY2yiO.js";import{$ as R,a as S}from"./useOverlayTrigger-CxphgibM.js";import{r as w,R as I}from"./index-D4H_InIO.js";import{F as f}from"./Flex-D88M4fXj.js";import"./index-BVDRNj0I.js";import"./useButton-5x9GnqB_.js";import"./useFocusable-DAd-_BRo.js";import"./useFocus-CVRFVd1p.js";import"./index-DW2zCSF8.js";import"./useUiKitComponents-D6-RnQKc.js";import"./useControlledState-Dxxc-Ijj.js";const D=s=>e.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:32,height:32,fill:"none",...s,children:e.jsx("path",{fill:"#fff",fillRule:"evenodd",d:"M7.516 5.63a1.333 1.333 0 1 0-1.885 1.886l8.485 8.486-8.485 8.485a1.333 1.333 0 1 0 1.886 1.886l8.485-8.485 8.485 8.485a1.333 1.333 0 0 0 1.886-1.886l-8.485-8.485 8.485-8.485a1.333 1.333 0 1 0-1.886-1.886l-8.485 8.485z",clipRule:"evenodd"})});try{Close.displayName="Close",Close.__docgenInfo={description:"",displayName:"Close",props:{}}}catch{}function q(s,r,o){let{overlayProps:l,underlayProps:a}=F({...s,isOpen:r.isOpen,onClose:r.close},o);return T({isDisabled:!r.isOpen}),C(),w.useEffect(()=>{if(r.isOpen&&o.current)return P([o.current])},[r.isOpen,o]),{modalProps:B(l),underlayProps:a}}const t=({label:s,children:r,...o})=>{const l=R(o),{triggerProps:a,overlayProps:u}=S({type:"dialog"},l);return e.jsxs(e.Fragment,{children:[e.jsx(m,{...o,...a,onPress:n=>{var b,h;(b=o==null?void 0:o.onPress)==null||b.call(o,n),(h=a==null?void 0:a.onPress)==null||h.call(a,n)},children:s}),l.isOpen&&e.jsx(p,{...o,state:l,children:I.cloneElement(r(()=>l.close()),u)})]})};try{t.displayName="ModalTrigger",t.__docgenInfo={description:"",displayName:"ModalTrigger",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},closeButtonSlot:{defaultValue:null,description:"",name:"closeButtonSlot",required:!1,type:{name:"((close: () => void) => ReactNode)"}}}}}catch{}const p=({state:s,children:r,closeButtonSlot:o,...l})=>{const a=w.useRef(null),{modalProps:u,underlayProps:n}=q(l,s,a);return e.jsx(O,{children:e.jsx(k,{contain:!0,autoFocus:!0,children:e.jsx(f,{...n,style:{...n.style},align:"center",justify:"center",bg:"background-secondary",position:{type:"fixed",top:0,left:0,right:0,bottom:0,zIndex:50},children:e.jsxs(E,{...u,style:{...n.style},ref:a,position:{type:"relative"},width:"100%",height:"100vh",p:{pt:52,pb:16,pr:16,pl:16},md:{p:{pt:36}},className:"overflow-auto",children:[l.isDismissable&&(o?o==null?void 0:o(()=>s.close()):e.jsx(m,{onPress:()=>s.close(),autoFocus:!0,variant:"transparent",border:{width:"0"},position:{type:"absolute",top:14,right:16},md:{position:{top:36,right:40}},children:e.jsx(D,{viewBox:"0 0 32 32",className:"w-6 h-6 md:w-8 md:h-8"})})),e.jsx(f,{justify:"center",align:"center",height:"100%",children:r})]})})})})};p.Trigger=t;try{p.displayName="Modal",p.__docgenInfo={description:"",displayName:"Modal",props:{state:{defaultValue:null,description:"",name:"state",required:!0,type:{name:"OverlayTriggerState"}},closeButtonSlot:{defaultValue:null,description:"",name:"closeButtonSlot",required:!1,type:{name:"((close: () => void) => ReactNode)"}}}}}catch{}const Z={title:"UI-Kit components/Modal",component:t,parameters:{docs:{description:{component:`Компонент ModalTrigger является кнопкой, которая открывает модалку при клике. 
...
}`,...(_=(v=c.parameters)==null?void 0:v.docs)==null?void 0:_.source}}};const ee=["Default","FormModal","NonDismissibleModal"];export{i as Default,d as FormModal,c as NonDismissibleModal,ee as __namedExportsOrder,Z as default};
