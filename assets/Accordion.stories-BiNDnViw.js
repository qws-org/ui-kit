...
}`,...(T=(q=p.parameters)==null?void 0:q.docs)==null?void 0:T.source}}};var V,D,W;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {},
  render: args => {
    const [expandedKeys, setExpandedKeys] = React.useState<Set<ID>>();
    const handleExpandedChange = (keys: Set<ID>): void => {
...
}`,...(W=(D=m.parameters)==null?void 0:D.docs)==null?void 0:W.source}}};var z,R,G;h.parameters={...h.parameters,docs:{...(z=h.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {},
  render: args => {
    const [expandedKeys, setExpandedKeys] = React.useState<Set<ID>>();
    const handleExpandedChange = (keys: Set<ID>): void => {
...
}`,...(M=(_=f.parameters)==null?void 0:_.docs)==null?void 0:M.source}}};var B,U,H;g.parameters={...g.parameters,docs:{...(B=g.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {},
  render: args => {
    const [expandedKeys, setExpandedKeys] = React.useState<Set<ID>>(new Set(["item-1"]));
    const handleExpandedChange = (keys: Set<ID>): void => {
...
}`,...(H=(U=g.parameters)==null?void 0:U.docs)==null?void 0:H.source}}};var F,N,J;y.parameters={...y.parameters,docs:{...(F=y.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => {
...
}`,...(J=(N=y.parameters)==null?void 0:N.docs)==null?void 0:J.source}}};const xe=["Default","SecondaryVariant","Disabled","CustomDurations","CustomHeadingWrapper","MultipleExpanded"],ke=Object.freeze(Object.defineProperty({__proto__:null,CustomDurations:f,CustomHeadingWrapper:g,Default:p,Disabled:h,MultipleExpanded:y,SecondaryVariant:m,__namedExportsOrder:xe,default:ye},Symbol.toStringTag,{value:"Module"}));export{f as C,p as D,m as S,h as a,g as b,ke as s};
