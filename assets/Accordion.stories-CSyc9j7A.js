...
}`,...(T=(K=p.parameters)==null?void 0:K.docs)==null?void 0:T.source}}};var V,z,D;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {},
  render: args => {
    const [expandedKeys, setExpandedKeys] = React.useState<Set<ID>>();
    const handleExpandedChange = (keys: Set<ID>): void => {
...
}`,...(J=(N=y.parameters)==null?void 0:N.docs)==null?void 0:J.source}}};const xe=["Default","SecondaryVariant","Disabled","CustomDurations","CustomHeadingWrapper","MultipleExpanded"],Pe=Object.freeze(Object.defineProperty({__proto__:null,CustomDurations:f,CustomHeadingWrapper:g,Default:p,Disabled:h,MultipleExpanded:y,SecondaryVariant:m,__namedExportsOrder:xe,default:ye},Symbol.toStringTag,{value:"Module"}));export{f as C,p as D,m as S,h as a,g as b,Pe as s};
