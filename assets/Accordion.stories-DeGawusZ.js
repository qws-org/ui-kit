...
- Reference to the “Account” shall mean an account registered by you on the Website after accepting and agreeing to these Terms.
`})}),n.jsx(i.Item,{id:"item-2",title:"Item 2",children:n.jsx(v,{content:`<ol>
...
</ol>`})}),n.jsx(i.Item,{id:"item-3",title:"Item 3",children:n.jsx(v,{content:`<p><img src="https://jpws-cms-dev-test-test.jack-flush.com/assets/b9a18fab-c61b-440a-8878-cd9c8e57c4da.jpg?width=1240&amp;height=900" alt="Bg Slider Desktop" loading="lazy"></p>
<ol>
<li style="font-size: 18pt;"><span style="font-size: 18pt;">The Cash Game Leaderboard promotion runs from May 19th, 2025 to June 8th, 2025, spanning three weekly rounds.</span></li>
</ol>
<ol start="2">
...
</ol>`})})]})}},m={args:{},render:e=>{const[r,o]=d.useState(),l=a=>{var s;o(a),(s=e.onExpandedChange)==null||s.call(e,a)},{Link:t}=de();return n.jsxs(i,{...e,onExpandedChange:l,expandedKeys:r,children:[n.jsx(i.Item,{id:"item-1",title:"Место для заголовка",variant:"secondary",children:n.jsx(v,{content:`## 1. Introduction
1.1. By using, visiting and/or accessing any part of the jack-poker.com website and/or registering an account on the Website, you agree to be bound by these Terms and Conditions of Service.
...
}`,...(V=(S=p.parameters)==null?void 0:S.docs)==null?void 0:V.source}}};var T,z,D;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {},
  render: args => {
    const [expandedKeys, setExpandedKeys] = React.useState<Set<ID>>();
    const handleExpandedChange = (keys: Set<ID>): void => {
...
}`,...(M=(_=f.parameters)==null?void 0:_.docs)==null?void 0:M.source}}};var U,B,F;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {},
  render: args => {
    const [expandedKeys, setExpandedKeys] = React.useState<Set<ID>>(new Set(["item-1"]));
    const handleExpandedChange = (keys: Set<ID>): void => {
...
}`,...(F=(B=g.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};var H,N,J;y.parameters={...y.parameters,docs:{...(H=y.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => {
...
}`,...(J=(N=y.parameters)==null?void 0:N.docs)==null?void 0:J.source}}};const xe=["Default","SecondaryVariant","Disabled","CustomDurations","CustomHeadingWrapper","MultipleExpanded"],$e=Object.freeze(Object.defineProperty({__proto__:null,CustomDurations:f,CustomHeadingWrapper:g,Default:p,Disabled:h,MultipleExpanded:y,SecondaryVariant:m,__namedExportsOrder:xe,default:ye},Symbol.toStringTag,{value:"Module"}));export{f as C,p as D,m as S,h as a,g as b,$e as s};
